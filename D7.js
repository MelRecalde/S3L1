...
let evenNumber = arrayNumbers.filter(n => n % 2 === 0)
...
let somma = num.reduce((a, sum ) => a + sum, 0)
console.log(somma)

/* ESERCIZIO 6 (map)
  Scrivi una funzione che, dato un array di soli numeri e un numero n come parametri, ritorni un secondo array con tutti i valori del precedente incrementati di n
*/
console.log("----------- ESERCIZIO 6 X-----------")
/*
function array(numbers,n) {
  return numbers.map(e => e + n)
}
let result = array(num,3)
console.log(result)
*/
/* ESERCIZIO 7 (map)
...
*/
console.log("----------- ESERCIZIO 7 X-----------")
/*
let arrayString = ["Enjoy" , "The" , "Journey"]

function newArray(){
  let stringLength = arrayNumbers.map(e => e )
}
*/
